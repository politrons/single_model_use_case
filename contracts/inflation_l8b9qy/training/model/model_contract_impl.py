...
_NUMERICAL_FEATURES: list[str] = ['avg_processing_time_w1', 'avg_processing_time_w2', 'avg_processing_time_w3', 'avg_processing_time_w4', 'cumulative_amount_paid', 'cumulative_nb_claim_paid', 'cumulative_nb_invoice_paid', 'nb_preauth', 'treatment_date_month']
...
_EXTRA_PARAMS: dict = {'random_state': 42, 'has_hyper_search': False, 'all_feature_transformers': ['robustscaler'], 'number_used_features': 9, 'temporal_reference_column': 'treatment_date', 'feature_columns': ['avg_processing_time_w1', 'avg_processing_time_w2', 'avg_processing_time_w3', 'avg_processing_time_w4', 'cumulative_amount_paid', 'cumulative_nb_claim_paid', 'cumulative_nb_invoice_paid', 'nb_preauth', 'treatment_date_month']}
