...
def create_preprocess(table_name: str):
    ...
    def _():
        return add_valid_row_and_dq_flags(spark, get_full_table_name(table_name, use_case="inflation"), get_primary_keys(table_name, use_case="inflation"))
...
def create_grouped_dq(table_name: str):
    ...
    @dp.expect_all(get_dq_rules(get_primary_keys(table_name, use_case="inflation")))
    def _():
